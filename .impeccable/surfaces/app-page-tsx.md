...
- Use a warm cream canvas (#F5F1E4), ink black (#22231F) with #2C2E2A rules, lime (#C9EC52), sky blue (#95CFEE), coral (#FF705D), and warm yellow (#F5C94A). Solid fills only; no gradients, glass, shadows, or generic SaaS cards.
...
- `MatchupRoute`: attacker and defender cartographic panels, coral move connector, primary KO result, and grouped weather/terrain/effect controls.
